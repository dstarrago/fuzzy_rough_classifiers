...
/**
 * One-class Fuzzy-Rough Instance-based Multi-instance (OFRIM) classifier family
 * factory. Class for generating any classifier from the OFRIM family.
 * <p>
 *
 * Internally contains several membership function definitions, each representing
 * one OFRIM classifier. The number of classifier definitions in the family is given
 * by <tt>size()</tt>. Use <tt>buildClassifier(int index)</tt> to create the
 * <tt>index</tt>-th classifier type in the list of the OFRIM family.
 * <p>
 *
 * Example usage:
 * <p>
 * <code>
 * OFRIMFactory f = new OFRIMFactory(); <br>
