...
/**
 * Class for a dataset of bags without a given class label in a dataset.
 *
 * @author Danel
 */
public class BagsNotFromClass extends Iterator {
   ...
   */
  public BagsNotFromClass(VarWriter<Instance> item, VarReader<Instances> set,
   ...
   * equal to the target class label then it can't be the next instance.
   *
